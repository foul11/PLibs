...
class Utils{
    static public function URL($base, $rel) {
        if (!$base) {
            return $rel;
        }
    ...
    static public function in_range($number, $min, $max, $inclusive = true){
    ...
    static public function curl_body($handle, $out){
        $header_size = curl_getinfo($handle, CURLINFO_HEADER_SIZE);
        
        return substr($out, $header_size);
    }
}